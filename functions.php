  ...
  <div id="splash-page">
    <div class="splash-col">
      ...
      <div class="report-btns-box">
		...
		<a href="https://ivet360.com/recession-proofing/" class="report-btn" target="_blank" rel="noreferrer">
          <p class="form-title">Recession Proofing</p>
          <i class="fas fa-long-arrow-alt-right arrow"></i>
        </a>
      </div>
    </div>
      ...
      <div id="results-inner">
        ...
        <div id="scorecard-results" class="results">
              ...
              <div class="row">
                <div class="row-inner no-border">
                  ...
                  <div class="col-four">
                    ...
                    <?php if ($entry['318'] == null) { ?>
                      <p class="no-notes">N/A</p>
                    <?php } else { ?>
                      <p><?php echo $entry['318'] ?></p>
                    <?php } ?>
					  <?php } else { ?>
					 <?php if ($entry['319'] == null) { ?>
                      <p class="no-notes">N/A</p>
                    <?php } else { ?>
                      <p><?php echo $entry['319'] ?></p>
                    <?php } ?>
					  <?php } ?>
                  </div>
                </div>
          ...
          <div class="scorecard-section" id="hr-section">
            <div class="top-bar">
              <div class="orange-title">
                <p>HR & Team Support Scorecards</p>
              </div>
              <div class="report-btns">
                <div class="toggle-btns">
                  <div class="toggle-cover"></div>
      ...
      <div id="index-inner">
        ...
        <div id="index" style="max-height: 0;">
          ...
          <ul class="index-col">
            ...
            <li class="index-item" data-id="16">16. Cost of COGs Tracking Tool <img class="check" src="/wp-content/uploads/2021/01/index-checkmark.svg" alt="Minus mark" /></li>
      ...
      <div class="marketing-results-column marketing-results-left">
        <div class="results-box" id="practice-goals">
          ...
          <div class="results-box-bottom">
            <ul>
              <li><img src="/wp-content/uploads/2020/10/iVET-VMBR-icon-yes.svg" alt="Check"> <?php echo $entry['2'] ?></li>
              <li><img src="/wp-content/uploads/2020/10/iVET-VMBR-icon-yes.svg" alt="Check"> <?php echo $entry['3'] ?></li>
              <li><img src="/wp-content/uploads/2020/10/iVET-VMBR-icon-yes.svg" alt="Check"> <?php echo $entry['4'] ?></li>
            </ul>
          </div>
        </div>
        <div class="results-box" id="pie-graph">
          ...
          <div class="results-box-bottom">
            ...
            <div class="pie-percentage">
              ...
              ?>
               <h2 class="ivet-data" data-raw="<?php echo $entry['12'] ?>"><?php echo round($ivet, 2) ?>%</h2>
              <?php } ?>
              <?php if ($entry['15.1'] != null) {
                $google = (int)$entry['16'] / (int)$total * 100;
              ?>
               <h2 class="google-ads-data" data-raw="<?php echo $entry['16'] ?>"><?php echo round($google, 2) ?>%</h2>
              <?php } ?>
              <?php if ($entry['18.1'] != null) {
                $facebook = (int)$entry['19'] / (int)$total * 100;
              ?>
                <h2 class="facebook-ads-data" data-raw="<?php echo $entry['19'] ?>"><?php echo round($facebook, 2)?>%</h2>
              <?php } ?>
              <?php if ($entry['21.1'] != null) {
                $yelp = (int)$entry['22'] / (int)$total * 100;
              ?>
              <h2 class="yelp-ads-data" data-raw="<?php echo $entry['22'] ?>"><?php echo round($yelp, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['24.1'] != null) {
              $print = (int)$entry['25'] / (int)$total * 100;
            ?>
              <h2 class="print-collateral-data" data-raw="<?php echo $entry['25'] ?>"><?php echo round($print, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['27.1'] != null) {
              $press = (int)$entry['28'] / (int)$total * 100;
            ?>
              <h2 class="press-data" data-raw="<?php echo $entry['28'] ?>"><?php echo round($press, 2)?>%</h2>
            <?php } ?>
            <?php if ($entry['30.1'] != null) {
              $sponsorships = (int)$entry['31'] / (int)$total * 100;
            ?>
              <h2 class="sponsorships-data" data-raw="<?php echo $entry['31'] ?>"><?php echo round($sponsorships, 2) ?>%</h2>
            <?php } ?>
            <?php /* if ($entry['33.1'] != null) {
              $events = $entry['34'] / $total * 100;
            ?>
              <h2 class="events-data" data-raw="<?php echo $entry['34'] ?>"><?php echo round($events, 2)?>%</h2>
            <?php } */ ?>
            <?php if ($entry['36.1'] != null) {
              $promotional = (int)$entry['37'] / (int)$total * 100;
            ?>
              <h2 class="promotional-items-data" data-raw="<?php echo $entry['37'] ?>"><?php echo round($promotional, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['39.1'] != null) {
              $videography = (int)$entry['40'] / (int)$total * 100;
            ?>
              <h2 class="videography-photography-data" data-raw="<?php echo $entry['40'] ?>"><?php echo round($videography, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['42.1'] != null) {
              $reminder = (int)$entry['43'] / (int)$total * 100;
            ?>
              <h2 class="reminder-platform-data" data-raw="<?php echo $entry['43'] ?>"><?php echo round($reminder, 2)?>%</h2>
            <?php } ?>
            <?php if ($entry['45'] != null) {
              $customOne = (int)$entry['47'] / (int)$total * 100;
            ?>
              <h2 class="custom-one-data" data-raw="<?php echo $entry['47'] ?>"><?php echo round($customOne, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['49'] != null) {
              $customTwo = (int)$entry['51'] / (int)$total * 100;
            ?>
              <h2 class="custom-two-data" data-raw="<?php echo $entry['51'] ?>"><?php echo round($customTwo, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['53'] != null) {
              $customThree = (int)$entry['55'] / (int)$total * 100;
            ?>
              <h2 class="custom-three-data" data-raw="<?php echo $entry['55'] ?>"><?php echo round($customThree, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['58'] != null) {
              $customFour = (int)$entry['60'] / (int)$total * 100;
            ?>
              <h2 class="custom-four-data" data-raw="<?php echo $entry['60'] ?>"><?php echo round($customFour, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['62'] != null) {
              $customFive = (int)$entry['64'] / (int)$total * 100;
            ?>
              <h2 class="custom-five-data" data-raw="<?php echo $entry['64'] ?>"><?php echo round($customFive, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['66'] != null) {
              $customSix = (int)$entry['68'] / (int)$total * 100;
            ?>
              <h2 class="custom-six-data" data-raw="<?php echo $entry['68'] ?>"><?php echo round($customSix, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['70'] != null) {
              $customSeven = (int)$entry['72'] / (int)$total * 100;
            ?>
              <h2 class="custom-seven-data" data-raw="<?php echo $entry['72'] ?>"><?php echo round($customSeven, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['74'] != null) {
              $customEight = (int)$entry['76'] / (int)$total * 100;
            ?>
              <h2 class="custom-eight-data" data-raw="<?php echo $entry['76'] ?>"><?php echo round($customEight, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['78'] != null) {
              $customNine = (int)$entry['80'] / (int)$total * 100;
            ?>
              <h2 class="custom-nine-data" data-raw="<?php echo $entry['80'] ?>"><?php echo round($customNine, 2) ?>%</h2>
            <?php } ?>
            <?php if ($entry['82'] != null) {
              $customTen = (int)$entry['84'] / (int)$total * 100;
            ?>
              <h2 class="custom-10-data" data-raw="<?php echo $entry['84'] ?>"><?php echo round($customTen, 2) ?>%</h2>
            <?php } ?>
            </div>
            ...
            <div class="budget-box-left">
              <ul>
                <?php if ($entry['7.1'] != null) {
                  $one = .01 * (int)$entry['6'];
                  ?>
                  <li><div class="budget-percentage"><p><?php echo $entry['7.1'] ?></p></div> $<?php echo number_format($one) ?></li>
                <?php } ?>
                <?php if ($entry['7.2'] != null) {
                  $two = .02 * (int)$entry['6'];
                  ?>
                  <li><div class="budget-percentage"><p><?php echo $entry['7.2'] ?></p></div> $<?php echo number_format($two) ?></li>
                <?php } ?>
                <?php if ($entry['7.3'] != null) {
                  $three = .03 * (int)$entry['6'];
                  ?>
                  <li><div class="budget-percentage"><p><?php echo $entry['7.3'] ?></p></div> $<?php echo number_format($three) ?></li>
                <?php } ?>
                <?php if ($entry['7.4'] != null) {
                  $four = .04 * (int)$entry['6'];
                  ?>
                  <li><div class="budget-percentage"><p><?php echo $entry['7.4'] ?></p></div> $<?php echo number_format($four) ?></li>
                <?php } ?>
                <?php if ($entry['7.5'] != null) {
                  $five = .05 * (int)$entry['6'];
                  ?>
                  <li><div class="budget-percentage"><p><?php echo $entry['7.5'] ?></p></div> $<?php echo number_format($five) ?></li>
                <?php } ?>
                <?php if ($entry['7.6'] != null) {
                  $ten = .1 * (int)$entry['6'];
                  ?>
                  <li><div class="budget-percentage"><p><?php echo $entry['7.6'] ?></p></div> $<?php echo number_format($ten) ?></li>
                <?php } ?>
              </ul>
            </div>
            <div class="budget-box-right">
              <h3>Your Revenue: $<?php echo number_format($entry['6']) ?></h3>
              <p>Our goal is to develop the most cost effective marketing plan while still achieving your hospital marketing goals. To get a better understanding of a traditionally healthy marketing spend, we look to have marketing costs account for roughly 1%-5% of total revenue. The revenue figure abovel is your accumulated trailing twelve months of revenue.</p>
            </div>
          </div>
        </div>
        <div class="results-box" id="marketing-tools">
          ...
          <div class="results-box-bottom">
            ...
            <?php if ($entry['15.1'] != null) { ?>
              <div class="marketing-tool-card google-ads-data">
                <h3>Google Ads</h3>
                <p>High adoption rates during the pandemic may have substantially increased your new client numbers, but keeping yourself in front of your clients and at the top of search engine results is an investment in the continuing financial health of your practice. Hospitals that utilize Google Ads saw a 5% increase in the number of reviews over those that did not. For iVET360 clients in particular, Google Ads are currently the leading contributor to new client generation.</p>
              </div>
            <?php } ?>
            <?php if ($entry['18.1'] != null) { ?>
              <div class="marketing-tool-card facebook-ads-data">
                <h3>Facebook Ads</h3>
                <p>Facebook Ads and boosted posts can be a valuable awareness generation tool for your practice. While conversions through Facebook are lower than we see with Google, this is an excellent promotional opportunity for new practices as well as established practices aiming to develop more community awareness around their brand. Boosted posts also serve as a means of increasing the visibility of special offers, and they also help to get your content in front of more of your followers.</p>
              </div>
            <?php } ?>
            <?php if ($entry['21.1'] != null) { ?>
              <div class="marketing-tool-card yelp-ads-data">
                <h3>Yelp Ads</h3>
                <p>According to our data, Yelp Ads are the least effective paid lead generation tool utilized by veterinary practices. We do not generally recommend allocating marketing funds to Yelp Ads, as those dollars are better spent elsewhere such as Google Ads (where the average ROI for our practices is 7x the annual investment). However, if you are currently in contract with Yelp for ads, that dollar amount will be represented here in your marketing plan. </p>
              </div>
            <?php } ?>
            <?php if ($entry['24.1'] != null) { ?>
              <div class="marketing-tool-card print-collateral-data">
                <h3>Print Collateral</h3>
                <p>Although the prevalence of print collateral is now waning as many hospitals transition to digital-first marketing efforts, there are still many instances in which print collateral is an appropriate investment. This category encompasses a wide variety of print materials, such as business cards, brochures, rack cards, flyers, handouts, folders, banners, posters, wayfinding signage and more. While design services are included as part of your service with iVET360, the cost of production is an additional expense to the hospital that should be reflected in your overall marketing budget. Hospitals that have recently rebranded, or those that have outdated materials, are likely to see a larger portion of their budget allocated to print collateral production. </p>
              </div>
            <?php } ?>
            <?php if ($entry['27.1'] != null) { ?>
              <div class="marketing-tool-card press-data">
                <h3>Press</h3>
                <p>This category represents traditional print ads, such as ads for a local paper or program and digital ads placed with an online magazine.  While some of these initiatives may be reciprocal and as such unpaid, there is typically an investment associated with the placement of ads of this type. As with print collateral, iVET360 will design your ad at no additional cost, however the cost to place the ad is an additional expense to the practice. </p>
              </div>
            <?php } ?>
            <?php if ($entry['30.1'] != null) { ?>
              <div class="marketing-tool-card sponsorships-data">
                <h3>Sponsorships & Events</h3>
                <p>For many hospitals, sponsorships are the key to enhanced community involvement. Sponsoring local events, charities and fundraisers can help to establish a hospital within its community and increase overall brand awareness. As with sponsorships, participation in such events can also elevate the hospital within its community. While sponsoring an event generally comes with a monetary donation of sorts, event participation comes with the additional cost for materials such as tents, special promotional items, and more. This estimate captures these costs.</p>
              </div>
            <?php } ?>
            <?php /* if ($entry['33.1'] != null) { ?>
              <div class="marketing-tool-card events-data">
            ...
            <?php if ($entry['36.1'] != null) { ?>
              <div class="marketing-tool-card promotional-items-data">
                <h3>Promotional Items</h3>
                <p>Promotional items can go a long way toward enhancing your customer experience. It is important to choose items that are useful and impactful, as the cost of promotional items can quickly obliterate your budget. Examples of common and effective promotional items include: bandanas, frisbees, collapsible water dishes, pet waste bags, leashes.</p>
              </div>
            <?php } ?>
            <?php if ($entry['39.1'] != null) { ?>
              <div class="marketing-tool-card videography-photography-data">
                <h3>Videography/Photography</h3>
                <p>While it can be expensive, custom videography and photography can have a hugely beneficial impact on your practice's overall marketing presence. In addition to representing your hospital even more authentically, photography and videography offers potential clients a glimpse into what their experience might be like.</p>
              </div>
            <?php } ?>
            <?php if ($entry['42.1'] != null) { ?>
              <div class="marketing-tool-card reminder-platform-data">
                <h3>Reminder Platform</h3>
                <p>Reminder platforms make it easier than ever to improve client compliance, and many also come with an app that allows clients to manage their pet's care right from their phone. Platforms like PetDesk and AllyDVM have become the rule, rather than the exception. If your practice doesn't have a reminder platform currently, it's time to consider this investment as a means of enhancing overall retention and compliance. </p>
              </div>
            <?php } ?>
            <?php if ($entry['45'] === 'Yes') { ?>
              <div class="marketing-tool-card custom-one-data">
